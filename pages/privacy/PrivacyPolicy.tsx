...
const PrivacyPolicy = () => (
  <Stack>
    ...
    <p>
      This privacy policy applies to the Isometria app (hereby referred to as
      &quot;Application&quot;) for mobile devices that was created by (hereby
      referred to as &quot;Service Provider&quot;) as a Free service. This
    ...
    <p>
      ...
      the Application and for a reasonable time thereafter. If you&apos;d like
      them to delete User Provided Data that you have provided via the
      Application, please contact them at theillustrator2001@gmail.com and they
    ...
    <div>
      ...
      <p>
        ...
        Service Provider (theillustrator2001@gmail.com) so that they will be
    ...
    <br />
    <p>This privacy policy is effective as of 2025-01-17</p>
    <br />
    ...
    <p>
      ...
      via email at theillustrator2001@gmail.com.
    </p>
    <hr />
    <p>
